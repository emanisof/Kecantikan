<div class="padding-top:20px;">
	<?php 
		$attr = array('class'=>' form-horizontal','role'=>'form','id'=>'fileupload');
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			...
			<input type="hidden" id="pasien-id" name="id_pasien" />
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-sm-4">
			<textarea class="form-control" id="keluhan" rows="5" name="keluhan" placeholder="Isikan Keluhan Pasien"></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="analisa" class="col-sm-2 control-label">Hasil Analisa</label>
		<div class="col-sm-4">
			<textarea class="form-control" id="anslisa" rows="5" placeholder="Hasil Dari Analisa" name="analisa"></textarea>
		</div>
	</div>
	<div class="form-group">
		<label for="hasil"class="col-sm-2 control-label">Tindakan Medis </label>
		<div class="col-sm-4">
			<textarea rows="5" class="form-control" placeholder="Tindakan Medis Yang dilakukan" name="tindakan"></textarea>
		</div>
	</div>
	<div class="form-group">
	...
	<div class="form-group">
	<label for="upload image buton" class="col-sm-2 control-label">Foto Dokumen</label>
	<div class="col-sm-7">
	<!-- Begiin Upload -->
